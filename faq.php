...
?>
<div style="margin:-18px;float:right;height:50px; width:50px; right:0px;top:0px;position:relative;z-index:10;background-color:white;">
  <span style="float:right;margin: 3px;" onclick="javascript:document.getElementById('scontent').innerHTML = '<center>Waiting for search ...</center>';">[ x ]</span>
</div>
<center>
  <span style="font-size:13pt;"><?=_('Frequently Asked Questions')?></span>
</center>
...
<div style="padding-left:150px;text-align:justify;">
  ...
  <br>
  <span>
    <a name="andor" style="margin-left:-40px;"><?=_('Can I search for multiple strings with AND/OR?')?></a>
  </span>
  <br>
  <?=_('No, not with the syntax <b>AND</b>/<b>OR</b>.')?>
  <br>
  <?=_('But whitespaces will automaticly interpreted as <b>AND</b>.')?>
  <br>
  <?php if($backend == "postgresql"){ ?>
  <?=_('In addition AND/OR can be searche via <b>regex</b>.')?>
  <br>
  <?php } ?>
  ...
  <br>
  <span>
    <a name="andor" style="margin-left:-40px;"><?=_('Can I search for messages from specific nick/sender?')?></a>
  </span>
  <br>
  <?=_('Yes, the syntax <b>sender=</b> will search for messages from the specific sender (or nicks that contain the given sender).<br>Mulitple <i>sender-syntax</i> can be given in one search.')?>
  <br>
  ...
  <br>
  <span>
    <a name="andor" style="margin-left:-40px;"><?=_('Can I search for multiple chats at once?')?></a>
  </span>
  <br>
  ...
  <br>
  <span>
    <a name="andor" style="margin-left:-40px;"><?=_('Can I search with <i>regex</i>?')?></a>
  </span>
  <br>
  ...
  <br>
  <span>
    <a name="andor" style="margin-left:-40px;"><?=_('Can I only search for messages?')?></a>
  </span>
  <br>
  ...
  <br>
  <span>
    <a name="andor" style="margin-left:-40px;"><?=_('Can I search messages just in a given timeperiod?')?></a>
  </span>
  <br>
