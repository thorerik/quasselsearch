  <div style="width:100%; background: #6699cc;color:white;" >
    <center>
      <form onsubmit="javascript:such(); return false" action="#">
        <span style="font-size: 11pt;font-weight:bold;color:white;margin:3px;">Quassel Backlog Search</span>
        <br />
  ...
  <div style="clear:both;width:100%;">
    <div id="scontent" style="overflow:auto;padding: 5px; text-align:left; vertical-align:top;">
      <font style="font-size:8pt;">
        <center>
          <?=_('Waiting for search ...')?>
        </center>
      </font>
    </div>
  </div>
