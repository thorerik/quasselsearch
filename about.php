...
?>
  <center>
    <a style="font-size:13pt;" target="_blank" href="http://m4yer.minad.de/quassel/"><?=_('Quassel Backlog Search')?></a>
    <br />
    ...
    <br />
    <br />
    <b><?=_('Special thanks go to:')?></b>
    <br />
    <b>brot</b> for bugfixing, testing, helping, finding features and bugs, building the environment, advertising, motivating and a lot more.
    <br />
    <b>The Quassel IRC Community</b> for feedback, finding bugs and using.
    <br />
    <b><a target="_blank" href="http://quassel-irc.org/">The Quassel IRC Team</a></b> for developing such a great IRC-Client.
    <br />
    <br />
  </center>